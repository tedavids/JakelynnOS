...
void kernel_main() {
   ...
   // init display 
    ...
    // run tests
    if (!cursortest()) {
        print("Cursor Tests failed\n\r");
    } else {
        print("Cursor Tests Successful\n\r");
    }
    if (!vgatest()) {
        print("VGA tests failed\n\r");
    } else {
        print("VGA tests succeeded\n\r");
    }
    if (!ttytest()) {
        print("TTY tests failed\n\r");
    } else {
        print("TTY tests successful\n\r");
    }
